...
public class Patients_Appointment_List extends AppCompatActivity {
    SharedPreferences pref;
    SharedPreferences.Editor editor;
    String url = "https://anil1.techsunware.org/loginapp/get_patients_appointmentlist.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_patients__appointment__list);
   /*progess = (ProgressBar) findViewById(R.id.progess);*/
    ...
    private void callNetwork(final String ids) {
        ...
        abc.show();
        RequestQueue requestQueue = Volley.newRequestQueue(Patients_Appointment_List.this);
                ...
                try {
                    ...
                    if (res.equalsIgnoreCase("ok")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            doctor_appointment_lists.add(new Doctor_appointment_Model(Type,doctorId,appointmentDate));
